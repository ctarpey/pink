### Plotting a PCA for each pop from PLINK for QC
...
ggplot(data= ALL_geo) + geom_point(aes(x=V3, y=V4, color= POPNAME, shape =LINEAGE), alpha=.5, size=3) +
  scale_colour_manual(values = tol9qualitative, name ="Population", labels = pop_key$POPNAME)   

ALL_col<- c("#cd5490","#cd5490","#c9cf4a","#c9cf4a","#7297ee","#7297ee","#61005e","#61005e", "#677f3e","#677f3e","#00158a","#00158a","#e0957e","#e0957e","#7F007F", "#5500AA", "#2A00D4", "#0000FF")
...
# pop_11	PDISAP13	"#00158a"
# pop_12	PSPINK14	"#00158a"
# pop_13	PKOPPE91 "#e0957e"
# pop_14	PKOPPE96	"#e0957e"
# pop_15	PSNOH03	"#00158a"
# pop_16	PSNOH96	"#00158a"
# pop_17	PTAUY09 "#e0957e"
# pop_18	PTAUY12	"#e0957e"
