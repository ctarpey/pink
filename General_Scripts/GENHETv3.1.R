...
#####################################################################################
#####################################################################################
dataset=read.table("X:/WORK/TARPEY/GENHETv3.1/batch3_16681_Genhet.txt",sep="\t",header=T)
locusname=scan("X:/WORK/TARPEY/GENHETv3.1/Loci.txt",what="character",sep="\t")
Htest=GENHET(dat=dataset,estimfreq="T",locname=locusname)
write.table(Htest,"X:/WORK/TARPEY/GENHETv3.1/GenHet_out.txt",sep="\t",row.names=F,quote=F)

dataset=read.table("C:/Users/Garrett McKinney/Desktop/GENHETv3.1/WesPops_GenHet.txt",sep="\t",header=T)
locusname=scan("C:/Users/Garrett McKinney/Desktop/GENHETv3.1/WesPops_GenHet_locusNames.txt",what="character",sep="\t")
WesPops_Htest=GENHET(dat=dataset,estimfreq="T",locname=locusname)
write.table(WesPops_Htest,"C:/Users/Garrett McKinney/Desktop/GENHETv3.1/WesPops_Htest.txt",sep="\t",row.names=F,quote=F)
