...
#Xvalues<-plot.pseudo.y(LG="1", plot="Y")
#Yvalues<-plot.pseudo.y(LG="1", plot="Y")
#YvaluesRight<-plot.pseudo.y(LG="1", plot="Y")
#Xvalues
#Yvalues
#YvaluesRight
#loess_fit_left <- loess(Yvalues ~ Xvalues)
#loess_fit_left
#predict(loess_fit_left)
#loess_fit_right <- loess(YvaluesRight ~ Xvalues)
#loess_fit_right
#predict(loess_fit_right)
