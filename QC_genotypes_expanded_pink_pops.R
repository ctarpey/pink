...
OLD_genepop<-read.table("Z:/WORK/TARPEY/Exp_Pink_Pops/STACKS/Filtering/QC_test_16681_new_genotypes/OLD_genepop_16662.txt",colClasses="character")
OLD_genepop[1:5,1:5]
dim(OLD_genepop)
#head(OLD_genepop)

NEW_genepop<-read.table("Z:/WORK/TARPEY/Exp_Pink_Pops/STACKS/Filtering/QC_test_16681_new_genotypes/NEW_genepop_16662.txt",colClasses="character")
NEW_genepop[1:5,1:5]
dim(NEW_genepop)
